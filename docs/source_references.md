...
3. **TAURUS Zenodo release** ? https://zenodo.org/records/14007626  
   Notes: annotated H5AD lineage objects are hosted here. The reproducibility-critical workflow in this package uses GEO processed 10x matrices and does not require annotated H5AD objects.
